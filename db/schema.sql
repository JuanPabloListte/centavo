...
-- Una fila por ingesta: cuánto tardó, cómo terminó, cuántos movimientos resolvió
-- cada vía y cuánto costó el modelo. Sin descripciones, montos, nombres ni texto
-- de errores. Ver app/corridas.py.
-- Para una base creada antes de este cambio: db/migraciones/004_corridas.sql
...
CREATE INDEX corridas_empezo_idx ON corridas (empezo_en DESC);
